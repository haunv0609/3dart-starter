...
class StarterServiceProvider extends ServiceProvider {
    ...
    public function publishing(): void
    {
        ...
        $this->publishes([
            '../database/migrations/add_description_to_permissions_and_role_tables.php.stub' => $this->getMigrationFileName('add_description_to_permissions_and_role_tables.php'),
